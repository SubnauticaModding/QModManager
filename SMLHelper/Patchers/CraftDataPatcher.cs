namespace SMLHelper.V2.Patchers
{
    ...
    internal class CraftDataPatcher
    {
        ...
        {
            Dictionary<TechGroup, Dictionary<TechCategory, List<TechType>>> groups = GroupsField.GetValue(null) as Dictionary<TechGroup, Dictionary<TechCategory, List<TechType>>>;
        ...
        {
            Dictionary<TechType, string> techMapping = CraftDataType.GetField("techMapping", BindingFlags.NonPublic | BindingFlags.Static).GetValue(null) as Dictionary<TechType, string>;
            Dictionary<string, TechType> entClassTechTable = CraftDataType.GetField("entClassTechTable", BindingFlags.NonPublic | BindingFlags.Static).GetValue(null) as Dictionary<string, TechType>;
