namespace SMLHelper.V2.Util
{
    ...
    public static class ReflectionHelper
    {
        ...
        public static object GetInstanceField<classInstance>(classInstance instance, string field, BindingFlags bindingFlags = BindingFlags.NonPublic | BindingFlags.Instance) where classInstance : class
        ...
        /// <exception cref="TargetException"/>
        /// <exception cref="ArgumentException"/>
        public static void SetInstanceField<classInstance>(classInstance instance, string field, object newValue, BindingFlags bindingFlags = BindingFlags.NonPublic | BindingFlags.Instance) where classInstance : class
