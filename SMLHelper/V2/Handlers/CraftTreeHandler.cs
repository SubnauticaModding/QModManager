...
namespace SMLHelper.V2.Handlers
{
    public class CraftTreeHandler
    {
        ...
        {
            CraftTreePatcher.CustomTabs.Add(new CustomCraftTab(path, name, scheme, sprite));
        }
        ...
        public static void AddCustomTab(CustomCraftTab tab)
        {
        ...
        {
            CraftTreePatcher.CustomNodes.Add(new CustomCraftNode(techType, scheme, path));
        }
        ...
        {
            CraftTreePatcher.CustomNodes.Add(new CustomCraftNode(moddedTechType, scheme, path));
        }
        ...
        public static void AddCustomNode(CustomCraftNode node)
        {
