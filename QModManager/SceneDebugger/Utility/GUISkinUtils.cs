...
{
    internal static class GUISkinUtils
    {
        internal static Dictionary<string, GUISkin> guiSkins = new Dictionary<string, GUISkin>();

        internal static GUISkin CreateDerived(GUISkin baseSkin = null, string name = null)
        {
            if (baseSkin == null)
            {
        ...
        internal static GUISkin RegisterDerived(string name, GUISkin baseSkin = null)
        {
        ...
        internal static GUISkin RegisterDerivedOnce(string name, Action<GUISkin> skinInitializer = null, GUISkin baseSkin = null)
        {
        ...
        internal static void RenderWithSkin(GUISkin skin, Action render)
        {
        ...
        internal static void SetCustomStyle(this GUISkin skin, string name, GUIStyle baseStyle, Action<GUIStyle> modify)
        {
